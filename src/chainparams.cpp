...
public:
    CMainParams() {
        ...
        const char* pszTimestamp = "China stocks extend 5-day losing streak";
        CTransaction txNew;
        txNew.nTime = 1440585792;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        genesis.nVersion = 1;
        genesis.nTime    = 1440585792;
        genesis.nBits    = bnProofOfWorkLimit.GetCompact();
        genesis.nNonce   = 2927793;
		
		hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x000008c3300ff4a8c4f1e5971aea6b5a1ca0061a946b27b6ace92368ebe19043"));
        assert(genesis.hashMerkleRoot == uint256("0x195e46167a5ec49fc6ed06bc48e424bfeca0336419f15fd63792d31d268d1840"));

        vSeeds.push_back(CDNSSeedData("95.85.26.198", "95.85.26.198"));
