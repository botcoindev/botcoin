...
const string strMessageMagic = "Botcoin Signed Message:\n";
...
int64_t GetProofOfWorkReward(int nHeight, int64_t nFees)
{
    int64_t nSubsidy = 0 * COIN;
        ...
        {
            nSubsidy = 40000 * COIN; // Pre-mine 40k COIN in first block
        } else {
            nSubsidy = 0;
        }
...
{
    int64_t nSubsidy = 0.02 * COIN;

    if(pindexBest->nHeight < 10000) // ~week 1
    {
    nSubsidy = 0.02 * COIN;
    }
    else if(pindexBest->nHeight < 18200) // ~week 2
    {
    nSubsidy = 0.05 * COIN;
    }
    else if(pindexBest->nHeight < 33200) // ~week 3
    {
    nSubsidy = 0.1 * COIN;
    }
