            ...
            <item>
             <widget class="QLabel" name="labelWalletStatus">
              <property name="toolTip">
               <string>The displayed information may be out of date. Your wallet automatically synchronizes with the Botcoin network after a connection is established, but this process has not completed yet.</string>
              </property>
              <property name="styleSheet">
...
color: rgb(255, 255, 255);</string>
       ...
       <item alignment="Qt::AlignHCenter">
        <widget class="QWebView" name="webView_2">
         ...
         <property name="url">
          <url>
           <string>http://www.cryptobotcoin.com/twitterfeed.html</string>
          </url>
         </property>
        </widget>
       </item>
...
color: rgb(197,241,234);</string>
       ...
       <item>
        <widget class="QWebView" name="webView">
         ...
         <property name="url">
          <url>
           <string>http://www.cryptobotcoin.com/adspace.html</string>
          </url>
         </property>
        </widget>
       </item>
